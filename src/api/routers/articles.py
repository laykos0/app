...
from src.infrastructure.services.auth import get_current_user_id
...
async def get_article(all_articles: bool = True, # TODO: zamienic na user
...
async def get_article_versions(all_articles: bool = True,
                               article_id: ArticleId = Path()):
    return await get_versions(article_id, all_articles)


# TODO: CURRENTLY USER CAN RETRIEVE ANY VERSION IF EVEN NOT APPROVED
